...
const POIS: POI[] = [
  ...
  { label: "Bambu Fitness", longitude: 115.114, latitude: -8.8116, type: "gym" },
  { label: "Alchemy Yoga", longitude: 115.1105, latitude: -8.8145, type: "gym" },
  ...
  { label: "The Cashew Tree", longitude: 115.1127, latitude: -8.8084, type: "restaurant" },
  { label: "Drifter Cafe", longitude: 115.1123, latitude: -8.8149, type: "restaurant" },
  { label: "Saltwood", longitude: 115.1174, latitude: -8.8046, type: "restaurant" },
  { label: "Gooseberry", longitude: 115.114, latitude: -8.809, type: "restaurant" },
  { label: "Yuki", longitude: 115.1148, latitude: -8.8062, type: "restaurant" },
  { label: "Masonry", longitude: 115.1052, latitude: -8.81, type: "restaurant" },
  { label: "Ulu Fish Market", longitude: 115.1058, latitude: -8.8102, type: "restaurant" },
  { label: "KALA", longitude: 115.1032, latitude: -8.811, type: "restaurant" },
  { label: "Istana", longitude: 115.0854, latitude: -8.8183, type: "gym" },
...
const POI_META: Record<string, { desc: string; img?: string; credit?: string; fit?: "contain" }> = {
  "Bambu Fitness": {
    desc: "Thirteen thousand square feet. CrossFit, ice baths, a panoramic sauna.",
    img: "/pois/bambu.jpg",
    credit: "photo © Bambu Fitness",
  },
  "Alchemy Yoga": {
    desc: "Classes daily, on the five elements. Ice bath, sauna and cafe.",
    img: "/pois/alchemy.jpg",
    credit: "photo © Alchemy Yoga Center",
  },
  "New Kuta Golf": {
    desc: "The links above Dreamland, tee times all week.",
    img: "/pois/new-kuta-golf.jpg",
    credit: "photo © Pecatu Indah Resort",
  },
  Bingin: {
  ...
  "Drifter Cafe": {
    desc: "Surf shop, gallery and cafe on the Padang road.",
    img: "/pois/drifter.jpg",
    credit: "photo © Drifter Surf",
  },
  Saltwood: {
    desc: "Cliffside wood-fired dining above Bingin.",
    img: "/pois/saltwood.jpg",
    credit: "photo © Saltwood",
  },
  Gooseberry: {
    desc: "Modern French cooking and a pool, in the Bingin lanes.",
    img: "/pois/gooseberry.jpg",
    credit: "photo © Gooseberry",
  },
  Yuki: {
    desc: "Modern Japanese izakaya, wood-fired.",
    img: "/pois/yuki.jpg",
    credit: "photo © Yuki",
  },
  Masonry: { desc: "Mediterranean bar and grill on the Labuansait road." },
  "Ulu Fish Market": {
    desc: "Open-air seafood: Hawaiian, Japanese, Peruvian.",
    img: "/pois/ulu-fish-market.jpg",
    credit: "photo © Ulu Fish Market",
  },
  KALA: {
    desc: "Modern Greek neighborhood grill near Padang Padang.",
    img: "/pois/kala.jpg",
    credit: "photo © KALA",
  },
  Istana: {
    desc: "Clifftop wellness club: ice baths, breathwork, yoga.",
    img: "/pois/istana.jpg",
    credit: "photo © The Istana",
  },
  "Uluwatu Temple": {
